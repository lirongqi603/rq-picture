...
public class PictureEditEventProducer {
    ...
    public void publishEvent(PictureEditRequestMessage pictureEditRequestMessage, WebSocketSession session, UserLoginVo loginUser, Long pictureId) {
        ...
        pictureEditEvent.setUser(loginUser);

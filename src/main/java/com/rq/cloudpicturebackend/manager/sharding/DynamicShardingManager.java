...
public class DynamicShardingManager {
    ...
    public static final String LOGIC_TABLE_NAME = "picture_public";
    private static final String BASE_TABLE_NAME = "picture";
    ...
    private Set<String> fetchAllPictureTableNames() {
        ...
        Set<String> tableNames = spaceIds.stream()
                .map(spaceId -> BASE_TABLE_NAME + "_" + spaceId)
                .collect(Collectors.toSet());
    ...
    private void updateShardingTableNodes() {
        ...
        if (shardingRule.isPresent()) {
            ...
            List<ShardingTableRuleConfiguration> updatedRules = ruleConfig.getTables()
                    .stream()
                    .map(oldTableRule -> {
                        if (BASE_TABLE_NAME.equals(oldTableRule.getLogicTable())) {
                            ShardingTableRuleConfiguration newTableRuleConfig = new ShardingTableRuleConfiguration(BASE_TABLE_NAME, newActualDataNodes);
    ...
    public void createSpacePictureTable(Space space) {
        ...
        if (space.getSpaceType() == SpaceTypeEnum.TEAM.getValue() && space.getSpaceLevel() == SpaceLevelEnum.FLAGSHIP.getValue()) {
            ...
            // 创建新表
            String createTableSql = "CREATE TABLE " + tableName + " LIKE picture_public";
            try {
